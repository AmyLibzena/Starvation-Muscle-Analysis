...
load('./Resource/Regulator-TF.mat');
...
temp_xlabel = 'TF transcript';
temp_ylabel = 'Number of Regulated Enzymes';

name_figure = 'RegulatorAnalysis-TF2Enzyme_T';
bar_YLim = [-300,300];
bar_FontSize = 8;
cutoff = 1;

%% Parameters - TF2Enzyme_P
temp_Info = Info_TF2Enzyme_P;
temp_data = data_TF2Enzyme_P;
temp_xlabel = 'TF protein';
temp_ylabel = 'Number of Regulated Enzymes';

name_figure = 'RegulatorAnalysis-TF2Enzyme_P';
bar_YLim = [-200,200];
bar_FontSize = 8;
cutoff = 0;
...
name_figure = 'RegulatorAnalysis-TF2Transporter_T';
bar_YLim = [-100,100];
bar_FontSize = 8;
cutoff = 1;

%% Parameters - TF2Transporter_P
temp_Info = Info_TF2Transporter_P;
temp_data = data_TF2Transporter_P;
temp_xlabel = 'TF protein';
temp_ylabel = 'Number of Regulated Transporters';

name_figure = 'RegulatorAnalysis-TF2Transporter_P';
bar_YLim = [-100,100];
bar_FontSize = 8;
cutoff = 0;
