%% Load files
load('./Resource/Regulator-Metabolite_OGTT.mat');

%% Parameters - Metabolite in Muscle
temp_Info = Info_Metabolite_muscle;
temp_data = data_Metabolite_muscle;
temp_xlabel = 'Responsive Metabolites';
temp_ylabel = 'Number of Regulations';

name_figure = 'RegulatorAnalysis_OGTT-Metabolite_muscle';
bar_YLim = [-200,500];
bar_FontSize = 8;
cutoff = 10;

%% Parameters - Metabolite in Liver
temp_Info = Info_Metabolite_liver;
temp_data = data_Metabolite_liver;
temp_xlabel = 'Responsive Metabolites';
temp_ylabel = 'Number of Regulations';

name_figure = 'RegulatorAnalysis_OGTT-Metabolite_liver';
bar_YLim = [-300,500];
bar_FontSize = 8;
cutoff = 20;
