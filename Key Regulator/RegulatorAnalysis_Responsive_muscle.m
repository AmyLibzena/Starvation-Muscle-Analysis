%% Load files
load('./Resource/Regulator-ResponsiveMetabolite_muscle.mat');
...
temp_xlabel = 'Responsive Metabolites (Substrate & Product)';
temp_ylabel = 'Number of Regulations';

name_figure = 'RegulatorAnalysis-ResponsiveMetabolite_SP';
bar_YLim = [-150,150];
bar_FontSize = 8;
cutoff = 10;
...
temp_xlabel = 'Responsive Metabolites (Cofactor)';
temp_ylabel = 'Number of Regulations';

name_figure = 'RegulatorAnalysis-ResponsiveMetabolite_CF';
bar_YLim = [-150,150];
bar_FontSize = 8;
cutoff = 1;
...
temp_xlabel = 'Responsive Metabolites (Activator)';
temp_ylabel = 'Number of Regulations';

name_figure = 'RegulatorAnalysis-ResponsiveMetabolite_AC';
bar_YLim = [-60,60];
bar_FontSize = 8;
cutoff = 6;
...
temp_xlabel = 'Responsive Metabolites (Inhibitor)';
temp_ylabel = 'Number of Regulations';

name_figure = 'RegulatorAnalysis-ResponsiveMetabolite_IN';
bar_YLim = [-150,150];
bar_FontSize = 8;
%cutoff = 10;
cutoff = 20;
