...
input <- "input/StarvationLiver_count.tsv"  # Input file with both WT and ob/ob data
...
for (tp in 1:8) {
  ...
  output_file <- paste(output_dir, "result_StarvationLiver_ANOVA_", time_point_suffix[tp], "h.txt", sep = "")
